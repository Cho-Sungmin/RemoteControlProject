...
// RemoteControl.cpp: 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
// CRemoteControlApp 생성

CRemoteControlApp::CRemoteControlApp() noexcept
{
	// 다시 시작 관리자 지원
	...
	SetAppID(_T("RemoteControl.AppID.NoVersion"));

	// TODO: 여기에 생성 코드를 추가합니다.
	// InitInstance에 모든 중요한 초기화 작업을 배치합니다.
}

// 유일한 CRemoteControlApp 개체입니다.

CRemoteControlApp theApp;


// CRemoteControlApp 초기화
