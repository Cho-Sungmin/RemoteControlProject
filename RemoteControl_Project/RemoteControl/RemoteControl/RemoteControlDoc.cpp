...
CRemoteControlDoc::CRemoteControlDoc() noexcept
{
	...
	randID = rand()%999999999 + 100000000;
	randPW = rand()%999999999 + 100000000;
...
bool CRemoteControlDoc::CheckSession(int id, int pw)
{
...
int CRemoteControlDoc::getUid()
{
	return uId;
}
void CRemoteControlDoc::setUid(int index)
{
	uId = index;
}